...
function EmptyTasksState() {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 dark:border-gray-200 dark:border-white/5 p-10 text-center bg-white dark:bg-white dark:bg-[#141A29] transition-colors duration-200">
      ...
      <p className="mb-1 text-base font-semibold text-gray-900 dark:text-gray-900 dark:text-white">No tasks yet</p>
      <p className="mb-4 text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-400">Try saying something like:</p>
        ...
        <div className="flex items-center justify-between rounded-2xl border border-violet-500/40 bg-gradient-to-r from-violet-500/15 to-purple-500/10 px-4 py-3 shadow-[0_0_20px_rgba(139,92,246,0.1)]">
          <div className="flex items-center gap-2.5">
            <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 shadow-lg shadow-violet-500/30">
              <ListTodo className="h-4 w-4 text-gray-900 dark:text-white" />
            </div>
            <div>
            ...
            {pendingTasks.length > 0 && (
              <span className="flex h-6 w-6 items-center justify-center rounded-full bg-violet-500 text-[11px] font-bold text-gray-900 dark:text-gray-900 dark:text-white shadow-md">
                {pendingTasks.length}
              </span>
            )}
          </div>
