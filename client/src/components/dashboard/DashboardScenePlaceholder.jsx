export default function DashboardScenePlaceholder() {
  return (
    <div className="space-y-4">
      ...
      <div className="relative flex h-96 flex-col items-center justify-center overflow-hidden rounded-3xl border border-violet-500/20 bg-[#141A29]/30 p-6 shadow-xl backdrop-blur-md">
        ...
        >
          ...
          <div className="absolute h-16 w-16 animate-pulse rounded-full border border-violet-500/40" />
        </div>
        ...
        <div className="pointer-events-none absolute left-0 top-0 h-8 w-8 rounded-tl-3xl border-l-2 border-t-2 border-violet-400" />
