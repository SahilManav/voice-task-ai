    ...
    <div className="rounded-3xl border border-gray-200 dark:border-white/5 bg-white dark:bg-[#141A29] border-gray-200 dark:border-white/5 p-6 space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-400 dark:text-gray-600 mt-0.5">Distribution across all tasks</p>
        </div>
        <span className="text-xs font-mono text-gray-400 dark:text-gray-600 border border-gray-200 dark:border-white/5 px-2 py-1 rounded-lg">
          {tasks.length} total
        </span>
      </div>
        ...
        {bars.map((bar) => (
          <div key={bar.label} className="space-y-1.5">
            <div className="flex items-center justify-between text-xs">
              <span className="text-gray-500 dark:text-gray-400 font-medium">{bar.label}</span>
              <span className="font-mono text-gray-400 dark:text-gray-600">{bar.count} tasks · {bar.pct}%</span>
            </div>
  ...
  return (
    <div className="rounded-3xl border border-gray-200 dark:border-white/5 bg-white dark:bg-[#141A29] border-gray-200 dark:border-white/5 p-6 space-y-5">
      <div>
        ...
        <p className="text-xs text-gray-400 dark:text-gray-600 mt-0.5">Visual breakdown by status</p>
      </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Real-time analytics computed from your task data</p>
      </div>
